...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _module_user_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./module/user.js */ \"./src/module/user.js\");\n/* harmony import */ var _module_game_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module/game.js */ \"./src/module/game.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\r\n\r\n\r\n\r\nconst baseURL = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/';\r\nconst id = 'oQNAEST2apGVZIoxn0tw';\r\nconst url = `${baseURL}games/${id}/scores`;\r\n\r\nconst ui = new _module_user_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\r\nconst newGame = new _module_game_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\r\n\r\n// submit score\r\nconst add = document.querySelector('.submit');\r\nadd.addEventListener('click', (e) => {\r\n  e.preventDefault();\r\n  const userInfo = ui.getUser();\r\n  newGame.addScore(userInfo.user, userInfo.score, url);\r\n});\r\n\r\nconst refresh = document.querySelector('.refresh');\r\nrefresh.addEventListener('click', () => {\r\n  const fetchedData = newGame.fetchData(url);\r\n  _module_user_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].resetBoard();\r\n  fetchedData.then((result) => {\r\n    const sortedList = _module_game_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].sortLeaders(Array.from(result));\r\n    _module_user_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].refreashBoard(sortedList);\r\n  });\r\n});\r\n\r\nwindow.addEventListener('load', () => {\r\n  const fetchedData = newGame.fetchData(url);\r\n  _module_user_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].resetBoard();\r\n  fetchedData.then((result) => {\r\n    const sortedList = _module_game_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].sortLeaders(Array.from(result));\r\n    _module_user_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].refreashBoard(sortedList);\r\n  });\r\n});\r\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
